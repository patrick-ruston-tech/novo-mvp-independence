...
export const metadata: Metadata = {
  ...
  description: 'Encontre casas, apartamentos e terrenos à venda em São José dos Campos e região. Filtros avançados para encontrar o imóvel ideal.',
  alternates: { canonical: 'https://independenceimoveis.com.br/comprar' },
};
...
async function SidebarWithData() {
  ...
  return <SidebarFilters transactionType="sale" neighborhoods={neighborhoods} condominiums={condominiums} />;
}
