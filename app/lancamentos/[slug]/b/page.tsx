      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-12">
        ...
        <div className="lg:col-span-5">
          <div className="sticky top-24">
            <div className="rounded-2xl overflow-hidden border border-gray-100 shadow-sm bg-white p-6">
              <h2 className="font-heading font-bold text-lg text-black mb-1">Tenho interesse no Lançamento</h2>
              <p className="text-xs text-gray-400 mb-4">Receba condições exclusivas</p>
