      ...
      <header className="sticky top-0 z-50 bg-white/95 backdrop-blur border-b border-gray-100 h-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center justify-between">
          ...
          <Link href="/" className="flex items-center flex-shrink-0" onClick={closeMenu}>
            <Image src="/logo.svg" alt="Independence Negócios Imobiliários" width={180} height={60} className="h-12 w-auto" priority />
          </Link>
          ...
          >
            ...
            <div className="flex items-center gap-4 p-4 border-b border-gray-100">
              ...
              <Link href="/" className="flex items-center" onClick={closeMenu}>
                <Image src="/logo.svg" alt="Independence" width={180} height={60} className="h-10 w-auto" />
              </Link>
            </div>
