      ...
      <div className="space-y-4">
        ...
        <div className="aspect-video rounded-xl overflow-hidden relative group">
          <div 
            ...
            style={{ backgroundColor: images[mainImageIdx] }}
          />
          <button 
        ...
        <div className="flex gap-2 overflow-x-auto pb-2">
          {images.map((img, idx) => (
            <button
              ...
              className={`flex-shrink-0 aspect-square w-16 rounded-lg overflow-hidden transition-all ${
                idx === mainImageIdx ? 'ring-2 ring-black ring-offset-2' : 'opacity-70 hover:opacity-100'
              }`}
            >
      ...
      {isFullscreen && (
        <div className="fixed inset-0 z-50 bg-black/95 flex flex-col animate-in fade-in duration-300">
          ...
          <div className="flex-grow flex items-center justify-center relative px-12">
            ...
            <div 
              className="w-full max-w-5xl aspect-video rounded-xl transition-colors duration-500"
              style={{ backgroundColor: images[mainImageIdx] }}
            />
